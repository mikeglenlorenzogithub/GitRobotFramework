...
var require_playwright_pb = __commonJS({
  "node/playwright-wrapper/generated/playwright_pb.js"(exports) {
    "use strict";
...
var require_playwright_grpc_pb = __commonJS({
  "node/playwright-wrapper/generated/playwright_grpc_pb.js"(exports) {
    "use strict";
    ...
    var PlaywrightService2 = exports.PlaywrightService = {
      // Cookie messages 
      addCookie: {
      ...
      waitUntilNetworkIsIdle: {
        path: "/Playwright/WaitUntilNetworkIsIdle",
        requestStream: false,
        responseStream: false,
        requestType: playwright_pb.Request.Timeout,
        responseType: playwright_pb.Response.Empty,
    ...
    exports.PlaywrightClient = grpc.makeGenericClientConstructor(PlaywrightService2);
  }
});
...
async function waitUntilNetworkIsIdle(request2, page) {
  const timeout = request2.getTimeout();
...
async function internalClick(selector, strictMode, options, state2) {
  ...
  try {
    ...
    if (error instanceof Error && error.message.startsWith("locator.click: Target closed")) {
      logger7.warn("Supress locator.click: Target closed error");
      return false;
    }
    throw error;
  }
...
async function handleAlert(request2, page) {
  ...
  const fn = async (dialog) => {
    ...
    if (promptInput)
      await dialog[alertAction](promptInput);
    else
      await dialog[alertAction]();
...
async function extensionKeywordCall(request2, call, state2) {
  ...
  if (!extension2)
    throw Error(`Could not find keyword ${keywordName}`);
...
var BrowserState = class {
  ...
  pushContext(newContext2) {
    if (newContext2 !== void 0) {
      ...
      logger8.info("Set active context to undefined");
  }
  ...
  get page() {
    ...
    if (context)
      return lastItem(context.pageStack);
    else
      return void 0;
  }
...
async function closeBrowserServer(request2, openBrowsers) {
  ...
  if (!browserServer)
    throw new Error(`BrowserServer with endpoint ${wsEndpoint} not found.`);
...
var PlaywrightServer = class {
  constructor() {
    ...
    this.waitUntilNetworkIsIdle = this.wrappingPage(waitUntilNetworkIsIdle);
